...
def _force_install_browser_deps():
    # 1. Paksa sistem mengabaikan error sertifikat/tanggal yang kedaluwarsa
    os.system("sudo apt-get -o Acquire::Check-Valid-Until=false update")
    # 2. Instal semua komponen OS yang dibutuhkan browser (mengatasi Error 127)
    os.system("sudo apt-get install -y libnss3 libnspr4 libatk1.0-0 libatk-bridge2.0-0 libcups2 libdrm2 libxkbcommon0 libxcomposite1 libxdamage1 libxfixes3 libxrandr2 libgbm1 libasound2")

_force_install_browser_deps()
